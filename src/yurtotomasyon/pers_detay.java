...
public class pers_detay extends JPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pers_detay frame = new pers_detay();
	...
	public pers_detay() {
		...
		JLabel lblNewLabel = new JLabel("PROF\u0130L DETAYLARI");
		...
		txtKaytTarihi.setBounds(457, 299, 285, 34);
		add(txtKaytTarihi);
		...
		txtOdaNo.setBounds(457, 226, 285, 34);
		add(txtOdaNo);
		...
		button_1.setBounds(257, 357, 285, 45);
